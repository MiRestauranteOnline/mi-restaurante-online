...
const translations = {
  es: {
    ...
    'content.ourStoryLabel': 'Etiqueta "Nuestra Historia"',
    'content.firstLineAboutTitle': 'Primera Línea del Título Acerca de',
    'content.secondLineAboutTitle': 'Segunda Línea del Título Acerca de',
    'content.aboutSectionDescription': 'Descripción de la Sección Acerca de',
    'content.aboutSectionImage': 'Imagen de la Sección Acerca de',
    'content.menuSection': 'Sección Menú',
    'content.culinaryMasterpiecesLabel': 'Etiqueta "Obras Maestras Culinarias"',
    'content.firstLineMenuTitle': 'Primera Línea del Título del Menú',
    'content.secondLineMenuTitle': 'Segunda Línea del Título del Menú',
    'content.menuSectionDescription': 'Descripción de la Sección Menú',
    'content.servicesSection': 'Sección Servicios',
    'content.ourServicesLabel': 'Etiqueta "Nuestros Servicios"',
    'content.firstLineServicesTitle': 'Primera Línea del Título Servicios',
    'content.secondLineServicesTitle': 'Segunda Línea del Título Servicios',
    'content.servicesSectionDescription': 'Descripción de la Sección Servicios',
    'content.reviewsSection': 'Sección Reseñas',
    ...
    'content.contactUsLabel': 'Etiqueta "Contáctanos"',
    'content.firstLineContactTitle': 'Primera Línea del Título Contacto',
    'content.secondLineContactTitle': 'Segunda Línea del Título Contacto',
    'content.contactSectionDescription': 'Descripción de la Sección Contacto',
    'content.hideReservationBox': 'Ocultar Caja de Reserva',
    'content.hideReservationBoxDesc': 'Ocultar el formulario de reserva en la sección de contacto',
    'content.ctaSection': 'Sección CTA',
    'content.ctaSectionTitle': 'Título de la Sección CTA',
    ...
    // Reviews Page
    'content.reviewsPage': 'Página de Reseñas',
    'content.reviewsPageHeroFirstLine': 'Primera Línea Hero Reseñas',
    'content.reviewsPageHeroSecondLine': 'Segunda Línea Hero Reseñas',
    'content.reviewsPageHeroDescription': 'Descripción Hero Reseñas',
    'content.reviewsPageHeroBackgroundImage': 'Imagen de Fondo Hero Reseñas',
    
    // Services Content
    'content.servicesContent': 'Contenido de Servicios',
    'content.serviceCards': 'Tarjetas de Servicios',
    'content.firstServiceCard': 'Primera Tarjeta de Servicio',
    'content.firstServiceCardIcon': 'Icono Primera Tarjeta',
    'content.firstServiceCardTitle': 'Título Primera Tarjeta',
    'content.firstServiceCardDescription': 'Descripción Primera Tarjeta',
    'content.firstServiceCardButton': 'Botón Primera Tarjeta',
    'content.firstServiceCardLink': 'Enlace Primera Tarjeta',
    'content.secondServiceCard': 'Segunda Tarjeta de Servicio',
    'content.secondServiceCardIcon': 'Icono Segunda Tarjeta',
    'content.secondServiceCardTitle': 'Título Segunda Tarjeta',
    'content.secondServiceCardDescription': 'Descripción Segunda Tarjeta',
    'content.secondServiceCardButton': 'Botón Segunda Tarjeta',
    'content.secondServiceCardLink': 'Enlace Segunda Tarjeta',
    'content.thirdServiceCard': 'Tercera Tarjeta de Servicio',
    'content.thirdServiceCardIcon': 'Icono Tercera Tarjeta',
    'content.thirdServiceCardTitle': 'Título Tercera Tarjeta',
    'content.thirdServiceCardDescription': 'Descripción Tercera Tarjeta',
    'content.thirdServiceCardButton': 'Botón Tercera Tarjeta',
    'content.thirdServiceCardLink': 'Enlace Tercera Tarjeta',
    'content.serviceFeatures': 'Características de Servicios',
    'content.firstFeatureIcon': 'Icono Primera Característica',
    'content.firstFeatureText': 'Texto Primera Característica',
    'content.secondFeatureIcon': 'Icono Segunda Característica',
    'content.secondFeatureText': 'Texto Segunda Característica',
    'content.thirdFeatureIcon': 'Icono Tercera Característica',
    'content.thirdFeatureText': 'Texto Tercera Característica',
    
    // Stats Content
    'content.statsContent': 'Contenido de Estadísticas',
    'content.statistics': 'Estadísticas',
    'content.firstStat': 'Primera Estadística',
    'content.firstStatIcon': 'Icono Primera Estadística',
    'content.firstStatNumber': 'Número Primera Estadística',
    'content.firstStatLabel': 'Etiqueta Primera Estadística',
    'content.secondStat': 'Segunda Estadística',
    'content.secondStatIcon': 'Icono Segunda Estadística',
    'content.secondStatNumber': 'Número Segunda Estadística',
    'content.secondStatLabel': 'Etiqueta Segunda Estadística',
    'content.thirdStat': 'Tercera Estadística',
    'content.thirdStatIcon': 'Icono Tercera Estadística',
    'content.thirdStatNumber': 'Número Tercera Estadística',
  ...
  en: {
    ...
    // Reviews Page
    'content.reviewsPage': 'Reviews Page',
    'content.reviewsPageHeroFirstLine': 'First Line Hero Title',
    'content.reviewsPageHeroSecondLine': 'Second Line Hero Title',
    'content.reviewsPageHeroDescription': 'Hero Description',
    'content.reviewsPageHeroBackgroundImage': 'Hero Background Image',
    
    // Services Content
    'content.servicesContent': 'Services Content',
    'content.serviceCards': 'Service Cards',
    'content.firstServiceCard': 'First Service Card',
    'content.firstServiceCardIcon': 'First Service Card Icon',
    'content.firstServiceCardTitle': 'First Service Card Title',
    'content.firstServiceCardDescription': 'First Service Card Description',
    'content.firstServiceCardButton': 'First Service Card Button',
    'content.firstServiceCardLink': 'First Service Card Link',
    'content.secondServiceCard': 'Second Service Card',
    'content.secondServiceCardIcon': 'Second Service Card Icon',
    'content.secondServiceCardTitle': 'Second Service Card Title',
    'content.secondServiceCardDescription': 'Second Service Card Description',
    'content.secondServiceCardButton': 'Second Service Card Button',
    'content.secondServiceCardLink': 'Second Service Card Link',
    'content.thirdServiceCard': 'Third Service Card',
    'content.thirdServiceCardIcon': 'Third Service Card Icon',
    'content.thirdServiceCardTitle': 'Third Service Card Title',
    'content.thirdServiceCardDescription': 'Third Service Card Description',
    'content.thirdServiceCardButton': 'Third Service Card Button',
    'content.thirdServiceCardLink': 'Third Service Card Link',
    'content.serviceFeatures': 'Service Features',
    'content.firstFeatureIcon': 'First Feature Icon',
    'content.firstFeatureText': 'First Feature Text',
    'content.secondFeatureIcon': 'Second Feature Icon',
    'content.secondFeatureText': 'Second Feature Text',
    'content.thirdFeatureIcon': 'Third Feature Icon',
    'content.thirdFeatureText': 'Third Feature Text',
    
    // Stats Content
    'content.statsContent': 'Stats Content',
    'content.statistics': 'Statistics',
    'content.firstStat': 'First Stat',
    'content.firstStatIcon': 'First Stat Icon',
    'content.firstStatNumber': 'First Stat Number',
    'content.firstStatLabel': 'First Stat Label',
    'content.secondStat': 'Second Stat',
    'content.secondStatIcon': 'Second Stat Icon',
    'content.secondStatNumber': 'Second Stat Number',
    'content.secondStatLabel': 'Second Stat Label',
    'content.thirdStat': 'Third Stat',
    'content.thirdStatIcon': 'Third Stat Icon',
