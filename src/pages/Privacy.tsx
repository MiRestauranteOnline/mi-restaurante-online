        ...
        <div className="space-y-8">
            ...
            <CardContent className="text-muted-foreground space-y-4">
              <div>
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li><strong>Información de Pago:</strong> Datos de tarjeta de crédito/débito (procesados de forma segura por nuestro procesador de pagos dLocal).</li>
          ...
          <Card>
            ...
            <CardContent className="text-muted-foreground space-y-4">
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li><strong>Procesamiento de Pagos:</strong> Facturar tu suscripción mensual mediante nuestro procesador de pagos dLocal.</li>
          ...
          <Card>
            ...
            <CardContent className="text-muted-foreground space-y-4">
              ...
              <div>
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li><strong>dLocal:</strong> Nuestro procesador de pagos que maneja de forma segura la información de tu tarjeta y procesa los cobros mensuales. dLocal actúa como procesador de datos y cumple con estándares PCI-DSS. Tu información de tarjeta nunca es almacenada en nuestros servidores.</li>
                </ul>
              </div>
              <div>
          ...
          <Card>
            ...
            <CardContent className="text-muted-foreground space-y-4">
              ...
              <p>
                dLocal, nuestro procesador de pagos, opera bajo regulaciones de la UK Financial Conduct Authority (FCA) y cumple 
          ...
          <Card>
            ...
            <CardContent className="text-muted-foreground space-y-4">
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>Procesamiento de pagos mediante procesador PCI-DSS certificado (dLocal)</li>
